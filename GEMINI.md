...
This project is a personal website, webpost hub, and resume for Bert Darnell. It is built with Next.js and uses the App Router. The webposts are powered by MDX, and the styling is done with Tailwind CSS. The site is designed to be simple, performant, and modern, with animations powered by Framer Motion.
...
*   **Content:** Webposts are written in MDX and stored in the `posts` directory.
