...
3. Install NVIDIA drivers in the VM (see [Jellyfin GPU Setup](/webpost/jellyfin-gpu-passthrough-setup))
...
**Next steps**:
- [Set up Jellyfin with GPU transcoding](/webpost/jellyfin-gpu-passthrough-setup)
