...
1. Proxmox GPU passthrough is configured (see [Proxmox GPU Passthrough Guide](/webpost/proxmox-gpu-passthrough))
...
- Consider setting up [WireGuard VPN](/webpost/wireguard-vpn-setup) for secure remote access
