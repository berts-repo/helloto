...
git clone https://github.com/berts-repo/lenovo-keyboard-rgb.git
...
The full code is available at [github.com/berts-repo/lenovo-keyboard-rgb](https://github.com/berts-repo/lenovo-keyboard-rgb). It includes:
