...
git clone https://github.com/screenpeak/lenovo-keyboard-rgb.git
...
The full code is available at [github.com/screenpeak/lenovo-keyboard-rgb](https://github.com/screenpeak/lenovo-keyboard-rgb). It includes:
